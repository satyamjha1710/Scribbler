...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `Scribbler_Join_Date` varchar(30) NOT NULL,
  PRIMARY KEY (`user_id`)
...
INSERT INTO `users` (`user_id`, `Name`, `Email`, `Password`, `Gender`, `Birthday_Date`, `Scribbler_Join_Date`) VALUES
...
CREATE TABLE IF NOT EXISTS `user_info` (
  ...
  `Scribbler_ID` varchar(100) NOT NULL,
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user_info` (`user_id`, `job`, `school_or_collage`, `current_city`, `hometown`, `relationship_status`, `mobile_no`, `mobile_no_priority`, `website`, `Scribbler_ID`) VALUES
(8, '', 'vccm', 'Rajkot', 'Rajkot', 'Single', '7600898210', 'Public', 'www.wix.com/amitad1i4/amit', 'www.Scribbler.com/Amit.000002');
