...
{error_reporting(1);
	...
	{
		session_start();
		$_SESSION['tempScribbleruser']=$user;
		...
		if($count2>0)
		{
			...
			if($count3>0)
			{
				...
				if($que2=="" && $ans2=="")
				{
					header("location:Scribbler_files/Scribbler_step/Scribbler_step3/Secret_Question2.php");
				}
				else
				{
				 	
					session_start();
					$_SESSION['Scribbleruser']=$user;
					...
					header("location:Scribbler_files/Scribbler_home/Home.php");
				}
				
			}
			else
			{
				header("location:Scribbler_files/Scribbler_step/Scribbler_step2/Secret_Question1.php");
			}
		}
		else
		{
