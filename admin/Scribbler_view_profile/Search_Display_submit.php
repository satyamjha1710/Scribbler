...
<div style="position:fixed; left:71.8%; top:0.6%; z-index:2;">
	...
	<tr id="hedarname2">
		...
		<td style="padding-top:7"> &nbsp; <a href="../Scribbler_logout/logout.php"> <img src="background_file/background_icons/logout3.png" height="20" width="20"> </a> </td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:1.2%; top:16.5%; z-index:1;">
	<table border="0">
	<tr>
		<td> <a href="../Scribbler_home/Home.php"> <img src="../Scribbler_home/img/admin.png" style="height:70; width:70;"> </a> </td>
		<td> &nbsp; <a href="../Scribbler_home/Home.php" onMouseOver="left_name_over()" onMouseOut="left_name_out()" style="color:#000000; font-size:12; font-weight:900;font-family:lucida Bright; text-transform:capitalize; text-decoration:none;" id="left_name">   Admin </a> </td>
	</tr>
	</table>
</div>
...
?>
		...
		<td bgcolor="#FFFFFF" style="padding-right:7;" id="Photo1<?php echo $uid ?>"> <a href="../Scribbler_view_profile/view_profile.php?id=<?php echo $uid; ?>"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $email; ?>/Profile/<?php echo $img; ?>" style="height:70; width:70;"> </a>  </td>
		
		<td onMouseOver="serched_name_over1(<?php echo $uid;?>)" onMouseOut="serched_name_out1(<?php echo $uid;?>)" width="500" bgcolor="#FFFFFF" id="Name_bg1<?php echo $uid; ?>"> <a href="../Scribbler_view_profile/view_profile.php?id=<?php echo $uid; ?>" style=" text-decoration:none; text-transform:capitalize; color:#3B5998;" id="Name_font1<?php echo $uid;?>">  <?php echo $name; ?> </a></td>
...
<div style="position:fixed; left:7%; top:35.7%;"> <a href="../Scribbler_home/Home.php"> <img src="img/News_Feed.PNG" onMouseOver="left_news_feed_over()" onMouseOut="left_news_feed_out()"> </a> </div>
<div style="position:fixed; left:9%; top:33%;"> <a href="../Scribbler_home/Home.php" style="text-decoration:none; color:#000;" id="news_feed" onMouseOver="left_news_feed_over()" onMouseOut="left_news_feed_out()"> <h4>News Feed</h4> </a></div>

<div style="position:fixed; left:7%; top:40.2%;"> <a href="../Scribbler_home/Settings.php"> <img src="img/settings2.png" height="25" width="23" onMouseOver="left_settings_over()" onMouseOut="left_settings_out()"> </a> </div>
<div style="position:fixed; left:9%; top:37%;"><a href="../Scribbler_home/Settings.php" style="text-decoration:none; color:#000;" id="settings" onMouseOver="left_settings_over()" onMouseOut="left_settings_out()"><h4>Settings</h4></a></div>
