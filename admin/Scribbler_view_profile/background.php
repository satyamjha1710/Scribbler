...
<?php 
	...
	$que_view_user_profile_pic=mysqli_query($link,"select * from user_profile_pic where user_id=$v_user_id");
	$user_profile_pic_data=mysqli_fetch_array($que_view_user_profile_pic);
	$profile_img=$user_profile_pic_data[2];


	$que_user_cover_pic=mysqli_query($link,"select * from user_cover_pic where user_id=$v_user_id");
	...
	$que_post_img=mysqli_query($link,"select * from user_post where user_id=$v_user_id and post_pic!='' order by post_id desc");
...
{
	mysqli_query($link,"update user_status set status='Offline' where user_id=$v_user_id");
}
if(isset($_POST['delete_user']))
{
		$delete_id=intval($_POST['delete_id']);
		mysqli_query($link,"delete from users where user_id=$delete_id;");
		header("location:../Scribbler_home/Home.php");
}
...
if(isset($_POST['warning_user']))
{
		...
		mysqli_query($link,"insert into user_warning values($warning_id,'$warning_txt')");
}
...
if(isset($_POST['file']) && ($_POST['file']=='Upload'))
{
		if($v_gender=="Male")
		{
			$path = "../../Scribbler_users/Male/".$v_email."/Profile/";
		}
		else
		{
			$path = "../../Scribbler_users/Female/".$v_email."/Profile/";
		}
		...
		if($v_gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Male/".$v_email."/Profile/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Female/".$v_email."/Profile/".$prod_img_path);
		}
    	mysqli_query($link,"update user_profile_pic set image='$img_name' where user_id=$v_user_id;");
...
if(isset($_POST['file1']) && ($_POST['file1']=='Upload'))
{
		if($v_gender=="Male")
		{
			$path = "../../Scribbler_users/Male/".$v_email."/Cover/";
		}
		else
		{
			$path = "../../Scribbler_users/Female/".$v_email."/Cover/";
		}
		...
		if($v_gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Male/".$v_email."/Cover/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Female/".$v_email."/Cover/".$prod_img_path);
		}
    	mysqli_query($link,"insert into user_cover_pic(user_id,image) values('$v_user_id','$img_name');");
		header("location:view_profile.php?id=".$v_user_id."");
}
...
if(isset($_POST['file2']) && ($_POST['file2']=='Upload'))
{
		...
		mysqli_query($link,"update user_cover_pic set image='$img_name' where user_id=$v_user_id;");
		header("location:view_profile.php?id=".$v_user_id."");
}
?>
<html>
...
<!--Head Scribbler text-->
<div style="position:fixed;left:4.05%;top:0.8%;font-size:25;font-weight:900; z-index:3;"> <a href="../Scribbler_home/Home.php" style="color:#FFFFFF; text-decoration:none;" onMouseOver="on_head_Scribbler_text()" onMouseOut="out_head_Scribbler_text()"> <font face="myScribblerFont"> Scribbler </font> </a> </div>
<!--Head Scribbler text background-->
<div style="position:fixed;left:4%;top:1%; height:5%; width:8%; z-index:2; background:#4A63A5; display:none;" id="head_Scribbler_text_backgraound">   </div>

<div style="position:fixed; left:12.7%; top:1.6%; z-index:2;">  <img src="background_file/background_icons/request.jpg">  </div>
<div style="position:fixed; left:14.7%; top:1.6%; z-index:2;"> <a href="../Scribbler_home/Group_Message.php"> <img src="background_file/background_icons/messages.jpg"> </a> </div>
<div style="position:fixed; left:16.7%; top:1.6%; z-index:2;">  <img src="background_file/background_icons/notifications.jpg">  </div>

<script>
	function bcheck()
	{
		s=document.Scribbler_search.search1.value;
...
<form name="Scribbler_search" action="../Scribbler_home/Search_Display_submit.php" method="get" onSubmit="return bcheck()">
...
<div style="position:fixed; left:90%; top:0.6%; z-index:2;">
	...
	<tr id="hedarname2">
		...
		<td style="padding-left:7;" id="head_img" onMouseOver="head_pro_pic_over()" onMouseOut="head_pro_pic_out()"> <a href="../Scribbler_home/Home.php">  <img src="img/admin.png" style="height:27; width:25;"> </a>  </td>
		
		<td id="head_name_bg"  onMouseOver="head_pro_pic_over()" onMouseOut="head_pro_pic_out()"> <a href="../Scribbler_home/Home.php" id="head_name_font" style="color:#DEDEEF; font-size:12; font-weight:900;font-family:lucida Bright; text-transform:capitalize; text-decoration:none;"> &nbsp;  Admin &nbsp;</a> </td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:97%; top:0.4%; z-index:2;"> <img src="background_file/background_icons/nexusae0_home_settings_icon2.png" height="35" width="35" onClick="close_option()"> </div>
        ...
        <a href="../Scribbler_home/Home.php"> <img src="img/News_Feed.PNG"  onMouseOver="head_new_over()" onMouseOut="head_new_out()"></a>
        </div>
        <div style="position:fixed; left:88%; top:5%; z-index:3;">
                 <a href="../Scribbler_home/Home.php" style="text-decoration:none; color:#000;" id="head_new" onMouseOver="head_new_over()" onMouseOut="head_new_out()" ><h4>News Feed</h4></a> 
        </div>
        
	<div style="position:fixed; left:86%; top:13%; z-index:3;"> <a href="../Scribbler_home/Settings.php"> <img src="img/settings2.png" height="25" width="23" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"> </a> </div>
<div style="position:fixed; left:88.2%; top:10%; z-index:3;"><a href="../Scribbler_home/Settings.php" style="text-decoration:none; color:#000;" id="head_settings" onMouseOver="head_settings_over()" onMouseOut="head_settings_out()"><h4> Account Settings </h4></a></div>

	<div style="position:fixed; left:86%; top:17.8%; z-index:3;"> <a href="../Scribbler_home/Group_Message.php"> <img src="img/group.png" height="25" width="23" onMouseOver="head_g_chat_over()" onMouseOut="head_g_chat_out()"> </a> </div>
<div style="position:fixed; left:88.2%; top:15%; z-index:3;"><a href="../Scribbler_home/Group_Message.php" style="text-decoration:none; color:#000;" id="head_g_chat" onMouseOver="head_g_chat_over()" onMouseOut="head_g_chat_out()"><h4> Group Chat </h4></a></div>

	<div style="position:fixed; left:86%; top:22.8%; z-index:3;"> <a href="../Scribbler_home/Notice.php"> <img src="img/Notice.png" height="25" width="23" onMouseOver="head_notice_over()" onMouseOut="head_notice_out()"> </a> </div>
<div style="position:fixed; left:88.2%; top:20%; z-index:3;"><a href="../Scribbler_home/Notice.php" style="text-decoration:none; color:#000;" id="head_notice" onMouseOver="head_notice_over()" onMouseOut="head_notice_out()"><h4> Notice </h4></a></div>

<div style="position:fixed; left:86.1%; top:27.5%; z-index:3;"> <a href="../Scribbler_home/feedback.php"> <img src="background_file/background_icons/icon-feedback.png" height="20" width="20" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"> </a> </div>
<div style="position:fixed; left:88.3%; top:24.5%; z-index:3;"><a href="../Scribbler_home/feedback.php" style="text-decoration:none; color:#000;" id="head_feedback" onMouseOver="head_feedback_over()" onMouseOut="head_feedback_out()"><h4> Feedback </h4></a></div>

<div style="position:fixed; left:86%; top:32.5%; z-index:3;"> <a href="../Scribbler_logout/logout.php"> <img src="background_file/background_icons/logout.png" height="20" width="20"  onMouseOver="head_logout_over()" onMouseOut="head_logout_out()"> </a> </div>
<div style="position:fixed; left:88.3%; top:29.1%; z-index:3;"><a href="../Scribbler_logout/logout.php" style="text-decoration:none; color:#000;" id="head_logout" onMouseOver="head_logout_over()" onMouseOut="head_logout_out()"><h4> Logout </h4></a></div>
</div>
...
<div style="position:absolute; left:15.11%; top:6%;">  <img src="../../Scribbler_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Cover/<?php echo $cover_img; ?>" height="279" width="943" onMouseOver="dis_cover_pic_edit();" onMouseOut="out_cover_pic_edit();" onClick="open_cover_photo()"> </div>
...
<div style="position:fixed; left:25%; top:29%; z-index:3;">
    <img src="../../Scribbler_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Profile/<?php echo $profile_img; ?>" style="height:240; width:240; z-index:3;">
</div>
...
<img src="../../Scribbler_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Cover/<?php echo $cover_img; ?>" style="height:500; width:800; ">
</div>
</div>
...
<div style="position:absolute; left:16.5%; top:33%; z-index:1;">
	<table border="0">
	<tr>
		<td>  <img src="../../Scribbler_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Profile/<?php echo $profile_img; ?>" style="height:150; width:150;" onMouseOver="dis_pro_pic_edit();" onMouseOut="out_pro_pic_edit();" onClick="open_profile_photo()">  </td>
...
<div style="position:fixed; background:#FFF; left:17%; top:5%; height:90%; width:65.5%; z-index:3"></div>
<div style="position:fixed; left:20%; top:10%;z-index:4;">
<img src="../../Scribbler_users/<?php echo $v_gender; ?>/<?php echo $v_email; ?>/Profile/<?php echo $profile_img; ?>" style="height:500; width:800; ">
</div>
</div>
...
<div style="position:fixed; background:#FFF; left:17%; top:5%; height:90%; width:65.5%; z-index:3"></div>
<div style="position:fixed; left:20%; top:10%;z-index:4;">
<img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:500; width:800; ">
</div>
</div>
...
?>
			 <tr>
			   	   <td> <a href="view_profile.php?id=<?php echo $online_user_id; ?>"> <img src="../../Scribbler_users/<?php echo $online_user_gender; ?>/<?php echo $online_user_Email; ?>/Profile/<?php echo $online_user_pic; ?>" height="30" width="30"> </a> </td>
