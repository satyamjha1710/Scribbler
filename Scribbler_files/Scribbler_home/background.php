...
<form name="Scribbler_search" action="Search_Display_submit.php" method="get" onSubmit="return bcheck()">
...
<div style="position:fixed; left:71.8%; top:0.6%; z-index:1;">
	...
	<tr id="hedarname2">
		...
		<td style="padding-left:7;" id="head_img" onMouseOver="head_pro_pic_over()" onMouseOut="head_pro_pic_out()"> <a href="../Scribbler_profile/Profile.php">  <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:27; width:25;"> </a> </td>
...
<div style="position:fixed; left:1.2%; top:16.5%; z-index:1;">
	<table border="0">
	<tr>
		<td> <a href="../Scribbler_profile/Profile.php"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:70; width:70;"> </a> </td>
		<td> &nbsp; <a href="../Scribbler_profile/Profile.php" onMouseOver="left_name_over()" onMouseOut="left_name_out()" style="color:#000000; font-size:12; font-weight:900;font-family:lucida Bright; text-transform:capitalize; text-decoration:none;" id="left_name">   <?php echo $name; ?> </a> </td>
	</tr>
	</table>
</div>
...
<div style="position:fixed; left:7.3%; top:40.6%;"> <a href="../Scribbler_profile/Profile.php"> <img src="img/timeline.png" width="16" height="16" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()"> </a> </div>
<div style="position:fixed; left:9%; top:37.2%;"><a href="../Scribbler_profile/Profile.php" style="text-decoration:none; color:#000;" id="timeline" onMouseOver="left_timeline_over()" onMouseOut="left_timeline_out()" ><h4>Timeline</h4></a></div>



<div style="position:fixed; left:7.2%; top:45.3%;"><a href="../Scribbler_profile/about.php"> <img src="img/about.png" onMouseOver="left_about_over()" onMouseOut="left_about_out()"> </a> </div>
<div style="position:fixed; left:9%; top:41.8%;"><a href="../Scribbler_profile/about.php" style="text-decoration:none; color:#000;" id="about" onMouseOver="left_about_over()" onMouseOut="left_about_out()"><h4>About</h4></a></div>



<div style="position:fixed; left:7%; top:49.3%;"> <a href="../Scribbler_profile/photos.php"> <img src="img/photo&video.PNG" onMouseOver="left_photos_over()" onMouseOut="left_photos_out()"> </a> </div>
<div style="position:fixed; left:9%; top:46%;"><a href="../Scribbler_profile/photos.php" style="text-decoration:none; color:#000;" id="photos" onMouseOver="left_photos_over()" onMouseOut="left_photos_out()"><h4>Photos</h4></a></div>
