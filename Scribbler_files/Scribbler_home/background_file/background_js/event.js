// Scribbler text
function on_head_Scribbler_text()
{
	document.getElementById("head_Scribbler_text_backgraound").style.display='block';
}
function out_head_Scribbler_text()
{
	document.getElementById("head_Scribbler_text_backgraound").style.display='none';
}
