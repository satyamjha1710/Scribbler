...
<div style="position:absolute;left:17%; top:139%; height:0.09%; width:66%; background:#CCC; z-index:1">
 ...
 <!--Basic Information--> 
 <?php
	$user_data_query=mysqli_query($link,"select * from users where user_id=$v_user_id");
...
?>
		<div style="position:absolute;left:61%;top:175%; color:#3B59A4; font-weight:bold;"> <?php echo $Scribbler_id; ?> </div>
