...
<?php
	...
	if(isset($_POST['file']) && ($_POST['file']=='post'))
	{
		...
		if($gender=="Male")
		{
			$path = "../../Scribbler_users/Male/".$user."/Post/";
		}
		else
		{
			$path = "../../Scribbler_users/Female/".$user."/Post/";
		}
		...
		if($gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Male/".$user."/Post/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Female/".$user."/Post/".$prod_img_path);
		}
...
?>
	<div style="position:absolute; left:15.5%; top:108%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img_array[0] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:108%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[1] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:108%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[2] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:125%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[3] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:125%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[4] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:125%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[5] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:15.5%; top:142%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[6] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:22%; top:142%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[7] ?>" height="90" width="78">  </div>
	<div style="position:absolute; left:28.5%; top:142%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Post/<?php echo $img_array[8] ?>" height="90" width="78">  </div>
