...
if(isset($_POST['file']) && ($_POST['file']=='Upload'))
{
		...
		{
			$path = "../../Scribbler_users/Female/".$user."/Profile/";
		}
		...
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Female/".$user."/Profile/".$prod_img_path);
		}
    	mysqli_query($link,"update user_profile_pic set image='$img_name' where user_id=$userid;");
...
if(isset($_POST['file1']) && ($_POST['file1']=='Upload'))
{
		if($gender=="Male")
		{
			$path = "../../Scribbler_users/Male/".$user."/Cover/";
		}
		else
		{
			$path = "../../Scribbler_users/Female/".$user."/Cover/";
		}
		...
		if($gender=="Male")
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Male/".$user."/Cover/".$prod_img_path);
		}
		else
		{
			move_uploaded_file($img_tmp_name,"../../Scribbler_users/Female/".$user."/Cover/".$prod_img_path);
		}
    	mysqli_query($link,"insert into user_cover_pic(user_id,image) values('$userid','$img_name');");
		header("location:Profile.php");
}
...
<?php 
	...
	$count_bg=$count_bg+1;
?>
<div style="position:absolute; left:15.11%; top:6%;"> <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Cover/<?php echo $cover_img; ?>" height="279" width="943" onMouseOver="dis_cover_pic_edit();" onMouseOut="out_cover_pic_edit();" onClick="open_cover_photo()"> </div>
...
<img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Cover/<?php echo $cover_img; ?>" style="height:500; width:800; ">
</div>
</div>
...
<div style="position:absolute; left:16.5%; top:33%; z-index:1;">
	<table border="0">
	<tr>
		<td>  <img src="../../Scribbler_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:150; width:150;" onMouseOver="dis_pro_pic_edit();" onMouseOut="out_pro_pic_edit();" onClick="open_profile_photo()">  </td>
		<td>  &nbsp; &nbsp; <a href="../Scribbler_profile/Profile.php" onMouseOver="left_name_over()" onMouseOut="left_name_out()" style="color:#FFFFFF; font-size:16; font-weight:900;font-family:lucida Bright; text-transform:capitalize; text-decoration:none; background-color:#000000;" id="left_name">   <?php echo $name; ?>  </a> </td>
	</tr>
	</table>
</div>
...
?>
			 <tr>
			   	   <td> <a href="../Scribbler_view_profile/view_profile.php?id=<?php echo $online_user_id; ?>"> <img src="../../Scribbler_users/<?php echo $online_user_gender; ?>/<?php echo $online_user_Email; ?>/Profile/<?php echo $online_user_pic; ?>" height="30" width="30"> </a> </td>
				   <td style="color:#ffffff;"> <a href="../Scribbler_view_profile/view_profile.php?id=<?php echo $online_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#ffffff;"> <?php echo $online_user_name; ?> </a> &nbsp; </td>	
