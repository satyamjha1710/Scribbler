...
<body>
	...
	<!-- Faceback left part -->
		...
		<!--Left part-->
		<!--Mobile Image--> 	
	<div style="position:absolute; left:5%; top:35%;"> <img src="Scribbler_files/Scribbler_index_file/Scribbler_image_file/Faceback_map.PNG" width="700" height="275"> </div>
    <div style="position:absolute; left:7%; top:24%; color:#3B5998; font-size:28px;"> <font face="myScribblerFont"> Scribbler helps you connect and share with </font> </div>
    <div style="position:absolute; left:7%; top:30%; color:#3B5998; font-size:28px;"> <font face="myScribblerFont"> the people in your life. </font></div>
